<div align="center">
  ...
  <span align="center">
    <b>Frime</b> - это многофункциональный Discord бот, который содержит в себе все самые важные и необходимые функции<br />
    для корректной работы сервера. В нём присутствует следующие категории команд:<br />
        1. Модерация<br />
        2. Утилиты<br />
        3. RolePlay команды<br />
        4. Команды для развлечения и т.д<br />
  </span>
